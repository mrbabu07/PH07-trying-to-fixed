...
const Boxes = ({ inProgressCount, resolvedCount }) => {
  return (
    <div className="bg-['/vector1.png')]">
      <div className="bg-[url('/vector2.png')]"></div>
      <div className="container mx-auto grid grid-cols-2 gap-[20px] p-4 my-[50px] bg-[url('/vector1.png')bg-[url('/vector2.png')] bg-cover bg-no-repeat">
